...
func main() {
	...
	publicHolidays[1] = fmt.Sprintf("%d%s", currentTime.Year(), "0410")
	publicHolidays[2] = fmt.Sprintf("%d%s", currentTime.Year(), "0501")
	publicHolidays[3] = fmt.Sprintf("%d%s", currentTime.Year(), "0509")
	publicHolidays[4] = fmt.Sprintf("%d%s", currentTime.Year(), "0518")
	publicHolidays[5] = fmt.Sprintf("%d%s", currentTime.Year(), "0529")
	...
	fmt.Printf("%d working days so %d working hours in total.\n", workingDaysCount, workingDaysCount*8)
}
